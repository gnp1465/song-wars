...
- `Online Room`: the Supabase-backed multiplayer path with anonymous sessions, six-digit room codes, live player/settings sync, removals, online topic setup, song submissions, bracket judging, scoring, and next-round flow.

Online play-again/reset, QR codes, payments, persistent history, and account upgrades are later milestones.
